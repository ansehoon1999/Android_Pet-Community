...
import org.mobileProgramming.maintermproject.ManagerFragment.ManagerFragment1;
import org.mobileProgramming.maintermproject.ManagerFragment.ManagerFragment2;
import org.mobileProgramming.maintermproject.ManagerFragment.ManagerFragment4;
import org.mobileProgramming.maintermproject.ManagerFragment.ManagerFragment5;
...
public class Manager extends AppCompatActivity {
    ...
    private ManagerFragment1 fragment1 = new ManagerFragment1();
    private ManagerFragment2 fragment2 = new ManagerFragment2();
    private ManagerFragment4 fragment4 = new ManagerFragment4();
    private ManagerFragment5 fragment5 = new ManagerFragment5();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpsTracker = new GpsTracker(Manager.this);
        ...
        if(latitude == null || longitude == null) {
            ...
            Bundle fragment1_bundle = new Bundle();
            fragment1_bundle.putString("MyAddress", address);
            fragment1_bundle.putString("displayname", displayname);
            fragment1.setArguments(fragment1_bundle);
            ...
            databaseReference = database.getReference("managerInfo");
    ...
    void checkRunTimePermission(){
        ...
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(Manager.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        int hasCoarseLocationPermission = ContextCompat.checkSelfPermission(Manager.this,
                Manifest.permission.ACCESS_COARSE_LOCATION);
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(Manager.this, REQUIRED_PERMISSIONS[0])) {

                // 3-2. 요청을 진행하기 전에 사용자가에게 퍼미션이 필요한 이유를 설명해줄 필요가 있습니다.
                Toast.makeText(getApplicationContext(), "이 앱을 실행하려면 위치 접근 권한이 필요합니다.", Toast.LENGTH_LONG).show();
                // 3-3. 사용자게에 퍼미션 요청을 합니다. 요청 결과는 onRequestPermissionResult에서 수신됩니다.
                ActivityCompat.requestPermissions(Manager.this, REQUIRED_PERMISSIONS,
